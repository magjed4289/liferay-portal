...
public class APIPropertyObjectDefinitionDeployerTest {
	...
	@Test
	@TestInfo("LPD-61326")
	public void testAPIBuilderObjectDefinitionsCreatedAndPublishedWithDBPartitioningEnabled()
		throws Exception {
		...
		HTTPTestUtil.customize(
			...
			"test@example.com", PropsValues.DEFAULT_ADMIN_PASSWORD
		).apply(
			() -> {
				JSONObject apiPropertyJSONObject =
					HTTPTestUtil.invokeToJSONObject(
