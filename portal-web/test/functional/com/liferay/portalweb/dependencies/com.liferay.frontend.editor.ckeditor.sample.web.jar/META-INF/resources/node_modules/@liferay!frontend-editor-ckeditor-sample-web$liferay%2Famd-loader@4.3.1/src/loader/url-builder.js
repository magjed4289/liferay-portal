Liferay.Loader.define('@liferay!frontend-editor-ckeditor-sample-web$liferay/amd-loader@4.3.1/src/loader/url-builder', ['module', 'exports', 'require'], function (module, exports, require) {
   ...
   */
    ...
    */
			build(moduleNames) {
				...
				if (bufferURL.length) {
					result = result.concat(this._generateBufferURLs(modulesURL, bufferURL, {
						basePath,
						url: config.url,
