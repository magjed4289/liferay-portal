Liferay.Loader.define('@liferay!frontend-editor-ckeditor-sample-web$liferay/amd-loader@4.3.1/src/loader/module', ['module', 'exports', 'require'], function (module, exports, require) {
   ...
   */
    ...
    */
			set map(map) {
				if (this._map) {
					throw new Error(`Local module map of module ${this.name} already set`);
				}
