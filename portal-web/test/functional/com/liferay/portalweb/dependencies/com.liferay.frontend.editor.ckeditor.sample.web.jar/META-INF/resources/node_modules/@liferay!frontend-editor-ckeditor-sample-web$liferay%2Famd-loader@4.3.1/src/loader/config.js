Liferay.Loader.define('@liferay!frontend-editor-ckeditor-sample-web$liferay/amd-loader@4.3.1/src/loader/config', ['module', 'exports', 'require'], function (module, exports, require) {
   ...
   */
    ...
    */
			_parse(cfg, property, defaultValue) {
				this._config[property] = Object.prototype.hasOwnProperty.call(cfg, property) ? cfg[property] : defaultValue;
			}
