Liferay.Loader.define('@liferay!frontend-editor-ckeditor-sample-web$liferay/amd-loader@4.3.1/src/loader/resolvable-promise', ['module', 'exports', 'require'], function (module, exports, require) {
   ...
   */
    ...
    */
			constructor() {
				throw new Error("Don't construct ResolvablePromise objects directly: " + 'rely on ResolvablePromise.new() instead');
			}
		}
