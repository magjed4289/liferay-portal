Liferay.Loader.define('@liferay!frontend-editor-ckeditor-sample-web$liferay/amd-loader@4.3.1/src/loader/script-loader', ['module', 'exports', 'require'], function (module, exports, require) {
   ...
   */
    ...
    */
			loadModules(moduleNames) {
				...
				const promises = modulesURLs.map(modulesURL => this._loadScript(modulesURL));
			...
			_loadScript(modulesURL) {
				...
				if (!script) {
					...
					script.onload = script.onreadystatechange = () => {
						...
						modules.forEach(module => {
							if (module.fetch.fulfilled) {
								this._log.warn(`Module '${module.name}' is being fetched from\n`, script.src, 'but was already fetched from\n', module.fetch.resolved ? module.fetch.resolution.src : module.fetch.rejection.script.src);
					...
					script.onerror = () => {
						...
						const error = Object.assign(new Error(`Unable to load script from URL ${modulesURL.url}`), {
